# Dot Net 9 with the Raspberry Pi

This is the source code to accompany my talk on Microsoft .NET 9 with the Raspberry Pi.
...
Pete Gallagher / Pete Codes / PJG Creations 2024

# Blog Post

You can read the accompanying blog post for this repository here;

[Install and use .NET 9 with the Raspberry Pi](http://bit.ly/dotnet9pi)

# .NET 9 Installation on a Raspberry Pi

You can install Dot Net 9 on the Raspberry Pi in one command by executing;
...
If you've cloned this repo, you can install Dot Net 9 by running the following in the root of the repo;
...
```
curl --output remotedebugsetup.bat https://raw.githubusercontent.com/pjgpetecodes/dotnet9pi/main/remotedebugsetup.bat && remotedebugsetup.bat
```
